...
public class SslEncryptionHandler implements EncryptionHandler {
   ...
   * @param sslFactory
   */
  public SslEncryptionHandler(SSLFactory sslFactory, TransportConf transportConf) {
    if (sslFactory == null)
   ...
   */
  @Override
  public void onConnect(final ChannelFuture channelFuture, final InetSocketAddress address) {
    ...
    future.awaitUninterruptibly(transportConf.connectionTimeoutMs());
  }
