 ...
 *
 */
public class SecureChunkFetchIntegrationSuite {
  ...
  public static void setUp() throws Exception {
    ...
    TransportContext context = new TransportContext(
      conf, handler, new SslEncryptionHandler(SSLSampleConfigs.createTrustedSSLFactory(), conf));
  ...
  private FetchResult fetchChunks(List<Integer> chunkIndices) throws Exception {
    System.out.println("Creating client to Server on port " + server.getPort());
