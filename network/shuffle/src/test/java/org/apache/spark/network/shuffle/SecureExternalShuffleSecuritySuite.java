...
public class SecureExternalShuffleSecuritySuite {
  ...
  public void beforeEach() {
    TransportContext context = new TransportContext(
      conf, new ExternalShuffleBlockHandler(conf),
      new SslEncryptionHandler(SSLSampleConfigs.createTrustedSSLFactory(), conf));
  ...
  private void validate(String appId, String secretKey, boolean encrypt) throws IOException {
    TransportEncryptionHandler encryptionHandler = new SslEncryptionHandler(
      SSLSampleConfigs.createTrustedSSLFactory(), conf);
    ExternalShuffleClient client = new ExternalShuffleClient(
      conf, new TestSecretKeyHolder(appId, secretKey), true, encrypt, encryptionHandler);
    client.init(appId);
